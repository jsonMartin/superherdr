...
| Identity, state separation and upstream compatibility | [Compatibility](specs/superherdr-compatibility/spec.md) | `tests/superherdr_rename.rs`; `src/protocol/wire.rs`; endpoint fixtures in `tests/fixtures/` |
