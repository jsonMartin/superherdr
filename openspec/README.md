...
| Identity, state separation and upstream compatibility | [Compatibility](specs/superherdr-compatibility/spec.md) | `tests/drop_in_herdr.rs`; `src/protocol/wire.rs`; endpoint fixtures in `tests/fixtures/` |
