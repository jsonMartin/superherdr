...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::WorkspaceSnooze(_) => "workspace.snooze",
        Method::WorkspaceWake(_) => "workspace.wake",
        Method::SnoozeReset(_) => "snooze.reset",
        Method::ProjectSnooze(_) => "project.snooze",
        Method::ProjectWake(_) => "project.wake",
        Method::SnoozeRecordWake(_) => "snooze.record.wake",
        Method::WorkspaceSnoozeSubscribe(_) => "workspace.snooze.subscribe",
        Method::SnoozeList(_) => "snooze.list",
